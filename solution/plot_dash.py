...
def create_timestamp_figure(data, title='Timestamp'):
    labels = ['Method', 'Timestamp']
...
def main(logs_path):
    ...
    def update_graphics(value):
        ...
        if label == 'fingerprint' or label == 'facial':
            ...
            return create_timestamp_figure(current_data, f'Total timestamp foreach upscalling method')
...
if __name__ == '__main__':
    logs_path = 'logs'
    app_ = main(logs_path)
    app_.run_server(debug=False, host='0.0.0.0')
